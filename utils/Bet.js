...
class Bet {
    ...
    constructor(betType, betAmount, fightEventID, fightEventDate, user1, user2, odds, betResolved) {
        ...
        if (!betAmount) throw new Exception("betAmount required to create bet."); 
        ...
        this.user1 = user1; //Ex. {User 1, fighterName}. Necessary
        this.user2 = user2; //Ex. {User 2, fighterName}. Only necessary when 1v1. Should be null for classic type bets   
